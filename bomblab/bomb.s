...
080486e0 <_init>:
 ...
 804870a:	8b 5d fc             	mov    0xfffffffc(%ebp),%ebx
 804870d:	c9                   	leave  
 804870e:	c3                   	ret    
...
080489b0 <main>:
 ...
 8048b16:	8b 5d e8             	mov    0xffffffe8(%ebp),%ebx
...
08048b48 <phase_2>:
 ...
 8048b8e:	8d 65 d8             	lea    0xffffffd8(%ebp),%esp
 8048b91:	5b                   	pop    %ebx
 8048b92:	5e                   	pop    %esi
...
08048b98 <phase_3>:
 ...
 8048ba5:	8d 45 fc             	lea    0xfffffffc(%ebp),%eax
 8048ba8:	50                   	push   %eax
 8048ba9:	8d 45 fb             	lea    0xfffffffb(%ebp),%eax
 8048bac:	50                   	push   %eax
 8048bad:	8d 45 f4             	lea    0xfffffff4(%ebp),%eax
 8048bb0:	50                   	push   %eax
 ...
 8048c02:	81 7d fc d6 00 00 00 	cmpl   $0xd6,0xfffffffc(%ebp)
 ...
 8048c18:	81 7d fc f3 02 00 00 	cmpl   $0x2f3,0xfffffffc(%ebp)
 ...
 8048c2a:	81 7d fc fb 00 00 00 	cmpl   $0xfb,0xfffffffc(%ebp)
 ...
 8048c42:	81 7d fc a0 00 00 00 	cmpl   $0xa0,0xfffffffc(%ebp)
 ...
 8048c54:	81 7d fc ca 01 00 00 	cmpl   $0x1ca,0xfffffffc(%ebp)
 ...
 8048c66:	81 7d fc 0c 03 00 00 	cmpl   $0x30c,0xfffffffc(%ebp)
 ...
 8048c78:	81 7d fc 0c 02 00 00 	cmpl   $0x20c,0xfffffffc(%ebp)
...
08048ca0 <func4>:
 ...
 8048cd5:	8d 65 e8             	lea    0xffffffe8(%ebp),%esp
 8048cd8:	5b                   	pop    %ebx
 8048cd9:	5e                   	pop    %esi
...
08048ce0 <phase_4>:
 ...
 8048cec:	8d 45 fc             	lea    0xfffffffc(%ebp),%eax
 8048cef:	50                   	push   %eax
...
08048d2c <phase_5>:
 ...
 8048d4f:	8d 4d f8             	lea    0xfffffff8(%ebp),%ecx
 ...
 8048d6b:	c6 45 fe 00          	movb   $0x0,0xfffffffe(%ebp)
 8048d6f:	83 c4 f8             	add    $0xfffffff8,%esp
 8048d72:	68 0b 98 04 08       	push   $0x804980b
 8048d77:	8d 45 f8             	lea    0xfffffff8(%ebp),%eax
 8048d7a:	50                   	push   %eax
 ...
 8048d8c:	8d 65 e8             	lea    0xffffffe8(%ebp),%esp
 8048d8f:	5b                   	pop    %ebx
 8048d90:	5e                   	pop    %esi
...
08048d98 <phase_6>:
 ...
 8048da4:	c7 45 cc 6c b2 04 08 	movl   $0x804b26c,0xffffffcc(%ebp)
 8048dab:	83 c4 f8             	add    $0xfffffff8,%esp
 8048dae:	8d 45 e8             	lea    0xffffffe8(%ebp),%eax
 8048db1:	50                   	push   %eax
 8048db2:	52                   	push   %edx
 ...
 8048dc0:	8d 45 e8             	lea    0xffffffe8(%ebp),%eax
 ...
 8048de0:	89 45 c8             	mov    %eax,0xffffffc8(%ebp)
 8048de3:	8d 75 e8             	lea    0xffffffe8(%ebp),%esi
 8048de6:	8b 55 c8             	mov    0xffffffc8(%ebp),%edx
 ...
 8048e04:	8d 4d e8             	lea    0xffffffe8(%ebp),%ecx
 8048e07:	8d 45 d0             	lea    0xffffffd0(%ebp),%eax
 8048e0a:	89 45 c4             	mov    %eax,0xffffffc4(%ebp)
 8048e0d:	8d 76 00             	lea    0x0(%esi),%esi
 8048e10:	8b 75 cc             	mov    0xffffffcc(%ebp),%esi
 ...
 8048e67:	8b 75 cc             	mov    0xffffffcc(%ebp),%esi
 8048e6a:	31 ff                	xor    %edi,%edi
 8048e6c:	8d 74 26 00          	lea    0x0(%esi),%esi
 ...
 8048e87:	8d 65 a8             	lea    0xffffffa8(%ebp),%esp
 8048e8a:	5b                   	pop    %ebx
 8048e8b:	5e                   	pop    %esi
 8048e8c:	5f                   	pop    %edi
...
08048e94 <fun7>:
 ...
 8048eab:	90                   	nop    
 8048eac:	8d 74 26 00          	lea    0x0(%esi),%esi
...
08048ee8 <secret_phase>:
 ...
 8048f05:	8d 43 ff             	lea    0xffffffff(%ebx),%eax
 ...
 8048f41:	8b 5d e8             	mov    0xffffffe8(%ebp),%ebx
...
08049030 <strings_not_equal>:
 ...
 8049069:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 ...
 804907f:	8d 65 e8             	lea    0xffffffe8(%ebp),%esp
 8049082:	5b                   	pop    %ebx
 8049083:	5e                   	pop    %esi
 8049084:	5f                   	pop    %edi
...
0804908c <open_clientfd>:
 ...
 80490f5:	8d 45 f0             	lea    0xfffffff0(%ebp),%eax
 80490f8:	50                   	push   %eax
 80490f9:	e8 42 f7 ff ff       	call   8048840 <bzero@plt>
 80490fe:	66 c7 45 f0 02 00    	movw   $0x2,0xfffffff0(%ebp)
 8049104:	83 c4 fc             	add    $0xfffffffc,%esp
 8049107:	8b 43 0c             	mov    0xc(%ebx),%eax
 804910a:	50                   	push   %eax
 804910b:	8d 45 f4             	lea    0xfffffff4(%ebp),%eax
 804910e:	50                   	push   %eax
 ...
 8049124:	66 89 45 f2          	mov    %ax,0xfffffff2(%ebp)
 8049128:	83 c4 fc             	add    $0xfffffffc,%esp
 804912b:	6a 10                	push   $0x10
 804912d:	8d 45 f0             	lea    0xfffffff0(%ebp),%eax
 8049130:	50                   	push   %eax
 8049131:	56                   	push   %esi
 ...
 8049157:	8d 65 d8             	lea    0xffffffd8(%ebp),%esp
 804915a:	5b                   	pop    %ebx
 804915b:	5e                   	pop    %esi
...
080491b0 <skip>:
 ...
 80491f3:	8b 5d e8             	mov    0xffffffe8(%ebp),%ebx
...
080491fc <read_line>:
 ...
 804927e:	8d 78 ff             	lea    0xffffffff(%eax),%edi
 ...
 80492b6:	8b 7d e8             	mov    0xffffffe8(%ebp),%edi
...
080492c0 <send_msg>:
 ...
 8049372:	8d 45 b0             	lea    0xffffffb0(%ebp),%eax
 ...
 8049389:	8d b4 26 00 00 00 00 	lea    0x0(%esi),%esi
 8049390:	83 c4 f8             	add    $0xfffffff8,%esp
 8049393:	50                   	push   %eax
 8049394:	8d 45 b0             	lea    0xffffffb0(%ebp),%eax
 8049397:	50                   	push   %eax
 ...
 80493b9:	50                   	push   %eax
 80493ba:	8d 45 b0             	lea    0xffffffb0(%ebp),%eax
 80493bd:	50                   	push   %eax
 ...
 80493f3:	53                   	push   %ebx
 80493f4:	8d 45 b0             	lea    0xffffffb0(%ebp),%eax
 80493f7:	50                   	push   %eax
 ...
 80494f0:	8d 65 98             	lea    0xffffff98(%ebp),%esp
 80494f3:	5b                   	pop    %ebx
 80494f4:	5e                   	pop    %esi
 80494f5:	5f                   	pop    %edi
...
0804952c <phase_defused>:
 ...
 804953c:	8d 5d b0             	lea    0xffffffb0(%ebp),%ebx
 804953f:	53                   	push   %ebx
 8049540:	8d 45 ac             	lea    0xffffffac(%ebp),%eax
 8049543:	50                   	push   %eax
 ...
 804959f:	8b 5d 98             	mov    0xffffff98(%ebp),%ebx
